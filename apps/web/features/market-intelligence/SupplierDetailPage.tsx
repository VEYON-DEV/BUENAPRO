...
export function SupplierDetailPage({ data }: { data: any }) {
  ...
  return <AppShell title="Mercado">
    ...
    <section className={styles.contracts}><header><h2>Licitaciones ganadas</h2><p>{data.contracts.length} resultados registrados</p></header><div className={styles.tableScroll}><table><thead><tr><th>Contrato</th><th>Servicio</th><th>Entidad</th><th>Región</th><th>Precio</th><th>Fecha</th><th></th></tr></thead><tbody>
